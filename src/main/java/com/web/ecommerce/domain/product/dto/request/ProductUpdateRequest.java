...
@Getter
@Schema(title = "ProductUpdateRequest", description = "상품 수정 요청")
public class ProductUpdateRequest {
    ...
    @Schema(description = "활성화 여부 (1: 활성, 0: 비활성)", example = "1")
    private Integer isActive;

    @Size(max = 500)
    @Schema(description = "이미지 URL (null이면 기존 유지)", example = "https://example.com/image.jpg")
