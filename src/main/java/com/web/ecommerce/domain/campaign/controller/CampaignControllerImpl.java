...
public class CampaignControllerImpl implements CampaignController {
  ...
  @Override
  @GetMapping
  public ResponseEntity<BaseResponse<List<CampaignResponse>>> getCampaigns(
      @RequestParam(required = false) Status status) {
    return ResponseEntity.ok(BaseResponse.success(campaignService.getCampaigns(status)));
  }
